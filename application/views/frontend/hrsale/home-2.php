		...
		<ul>
			<li data-fstransition="fade" data-transition="fade" data-slotamount="10" data-masterspeed="300">
				...
				<div class="caption text align-center sfb" data-x="center" data-y="270" data-speed="400" data-start="1200" data-easing="easeOutExpo">
					<p>Mathrix is most trusted job board, connecting the world's <br> brightest minds with resume database loaded with talents.</p>
				</div>
	...
	<div class="container">
		...
		<div class="one-third column">
			<div class="icon-box rounded alt">
				...
				<p>Create a profile, get it to a 100% and immediately get noticed by the right recruiters.</p>
			</div>
		</div>
		...
		<div class="one-third column">
			<div class="icon-box rounded alt">
				...
				<p>Search or get recommendations for jobs that match what you're looking for.</p>
			</div>
		</div>
		...
		<div class="one-third column">
			<div class="icon-box rounded alt">
				...
				<h4>Be the Best Candidate</h4>
				<p>Get access to career guidance and advice via the "Career Centre" and standout from the rest.</p>
			</div>
		</div>
